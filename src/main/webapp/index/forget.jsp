            ...
            <form action="forget" method="post">
                <div class="register-top-grid">
                    ...
                    <div class="input" style="margin-left: 160px">
                        ...
                        <input type="text" name="username" placeholder="请输入用户名" style="width: 350px;height: 32px">
                    </div>
                    <div class="input" style="margin-left: 160px">
                        <span>手机号 <label style="color:red;">*</label></span>
                        <input type="text" name="phone" placeholder="请输入手机号" style="width: 350px;height: 32px">
                    </div>
