...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="adminReset" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="layui-input" id="input_pass" name="password" required="required">
			</div>
		</div>
		<div class="form-group">
			<label for="input_pass_new" class="col-sm-1 control-label">新密码</label>
			<div class="col-sm-5">
				<input type="text" class="layui-input" id="input_pass" name="passwordNew" required="required">
			</div>
		</div>
		<div class="form-group">
