...
<div class="container-fluid">
	...
	<div class="text-right"><a style="text-decoration: none;color: white" class="layui-btn layui-btn-warm" href="goodAdd">添加商品</a></div>
...
<%--						<a class="btn btn-danger" href="goodDelete?id=${good.id}">删除</a>--%>
						<a href="goodDelete?id=${good.id}"><button type="button" class="layui-btn layui-btn-sm layui-btn-danger"><i class="layui-icon">删除</i></button></a>
				</div>
			</td>
       	</tr>
     </c:forEach>
